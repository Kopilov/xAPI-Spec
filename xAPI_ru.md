...
```  
Больше примеров приведено в [Приложении A: Примеры Утверждений](#AppendixA). 
...
<table border ="1">
	<tr><th>Свойство</th><th>Тип</th><th>Описание</th><th>Примечание</th></tr>
	<tr><td>objectType</td><td>Строка</td><td>"Group". </td><td>Обязательное</td></tr>
	<tr><td>name</td><td>Строка</td><td>Имя группы.</td><td>Опциональное</td></tr>
...
<table border ="1">
	...
	<td>Опциональное</td></tr>
	<tr><td colspan="2">см. <a href="#inversefunctional"> 4.1.2.3 Обратный идентификатор</a></td>
	    <td>Обратный идентификатор, уникальный для группы.</td><td>Обязательное</td></tr>
</table>
