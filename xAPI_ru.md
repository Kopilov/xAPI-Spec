...
<tr>
	<td>extensions</td>
	<td>Объект</td>
	<td>Набор других контекстных свойств Утверждения, специфических для системы. Нпример,
...
###### Детали
Существует четыре типа конекста. Любой из них МОЖЕТ быть использован, в том числе все или ни одного.
