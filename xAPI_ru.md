...
* Языковые ключи локализованных полей ОБЯЗАНЫ иметь корректное значение по стандарту
...
* LRS ОБЯЗАН для локализованных полей проверять как минимум что длина подэлементов и их
...
* LRS МОЖЕТ использовать максимально эффективную проверку для ключей локализованных полей
