...
и читающие записи, не должны быть Источниками задач. Хранилища могут
взаимодействовать меджу собой и с системами отчётов.

* Методы защиты, обеспечивающие надёжный обмен данными между Хранилищем и доверенными источниками.
