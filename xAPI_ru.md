...
* Утверждение ОБЯЗЯНО указывать каждое свойство не более одного раза.
* Утверждение ОБЯЗЯНО указывать свойства "actor", "verb", и "object".
* Утверждение МОЖЕТ указывать свойства в любом порядке.

###### Пример

An Пример простейшего Утверждения, использующего все свойства, которые ОБЯЗАНЫ или ДОЛЖНЫ быть использованы:  
```
{
